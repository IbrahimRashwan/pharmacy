...
export const routes: Routes = [
  ...
  { path:'category', loadChildren: () => import("./modules/category/category.routes"), canActivate: [authGuardFn([Role.Doctor, Role.SuperAdmin])]},
  { path:'order', loadChildren: () => import("./modules/order/order.routes"), canActivate: [authGuardFn([Role.Doctor, Role.SuperAdmin])]},
